...
g1a <- 
  ...
  geom_smooth(aes(fill = family_aware, linetype = gender), col = "black", alpha = 0.8, se=FALSE) + 
  geom_smooth(aes(fill = family_aware), col = "black", alpha = 0.8) + 
  geom_smooth(aes(fill = family_aware, linetype = gender), col = "black", alpha = 0.8, show.legend=FALSE) + 
  scale_x_continuous("Age") + 
  scale_y_continuous("Proportion of isolates tested\n that are resistant") + 
  ...
  scale_shape("Sex", labels = c("Female", "Male"), guide = guide_legend(override.aes = list(alpha = 0.5))) + 
